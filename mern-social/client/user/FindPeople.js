...
const useStyles = makeStyles(theme => ({
  ...
  searchInput: {
    ...
    '&:hover': {
      ...
      border: '2px solid #ccc', // sentuhan border yang lebih menonjol
    },
    '&:focus': {
      backgroundColor: '#fff',
      boxShadow: `${theme.shadows[2]} 0px 0px 8px 0px rgba(0,0,0,0.12)`,
      border: '2px solid #ccc', // sentuhan border yang lebih menonjol saat fokus
    },
  }
}))
...
export default function FindPeople() {
  ...
  const filteredUsers = values.users.filter(user =>
    user.name.toLowerCase().includes(values.searchText.toLowerCase())
  )
